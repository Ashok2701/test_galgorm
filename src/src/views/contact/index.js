...
const ContactComponent = () => {
  ...
  const role = {
    4: { title: 'Administrateur', color: 'light-dark' },
    2: { title: 'Client', color: 'light-success' },
    3: { title: 'Fournisseur', color: 'light-warning' }
  }
  
  const status = {
    2: { title: 'Actif', color: 'light-success' },
    1: { title: 'Inactif', color: 'light-dark' }
  }
