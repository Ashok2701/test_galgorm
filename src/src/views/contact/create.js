...
const CreateContactComponent = (props) => {
  ...
  const onSubmit = () => {
    ...
    if (isObjEmpty(errors) && contact.concode) {
      if (contact.id) {
        return mySwal.fire({
          title: 'Êtes-vous sûr ?',
          text: "Vous n'aurez pas à mettre à jour ce contact !",
          icon: 'warning',
  ...
  return (
    <div className="w-100">
      <CardTitle tag='h4'>{contact.id ? 'CONTACT MISE À JOUR' : 'CRÉER UN CONTACT'}</CardTitle>
      <Row>
        <Col sm='12'>
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Card>
              <CardBody className="pt-1">
                <Row>
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='x3user'>Partenaire d'affaires <span className='text-danger'>*</span></Label>
                      <Select
                        id='x3user'
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='fname'>Prénom <span className='text-danger'>*</span></Label>
                      <Input
                        name='fname'
                        id='fname'
                        value={contact.fname}
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='lname'>Nom de famille <span className='text-danger'>*</span></Label>
                      <Input
                        name='lname'
                        id='lname'
                        value={contact.lname}
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='concode'>Code de contact <span className='text-danger'>*</span></Label>
                      <Input
                        name='concode'
                        id='concode'
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='language'>Langue <span className='text-danger'>*</span></Label>
                      <Select
                        id='language'
                        theme={selectThemeColors}
                        classNamePrefix='select'
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='designation'>Désignation <span className='text-danger'>*</span></Label>
                      <Select
                        id='designation'
                        theme={selectThemeColors}
                        classNamePrefix='select'
                        name='designation'
                        placeholder='Sélectionner la désignation'
            ...
            <Button type='submit' onClick={() => setSubmitted(true)} className='mr-1' color='primary'>
              {contact.id ? 'Mettre à jour' : 'Créer'}
            </Button>
            {/* <Button type='reset' color='secondary' className='mr-1' outline tag={Link} to='/users'>Cancel</Button> */}
            <Button type='button' color='danger' outline tag={Link} to='/admin/contact'>Retour</Button>
          </Form>
        </Col>
      </Row>
    </div>
