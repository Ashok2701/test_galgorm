        ...
        <Col sm='12'>
          <Card>
            <CardHeader className='border-bottom'>
              <CardTitle tag='h4'>DÉTAILS DE LA DEMANDE DE COMMANDE DE VENTE</CardTitle>
            ...
            <CardBody className="pt-1">
              <Form onSubmit={handleSubmit(onSubmit)}>
                <Row>
                  <Col md='4' sm='12'>
                                      <FormGroup>
                                        <Label for='ID'>ID de la demande de commande client</Label>
                                        <Input
                                          name='site'
                                          id='site'
                 ...
                 <Col md='4' sm='12'>
                                                       <FormGroup>
                                                         <Label for='deliveryMode'>Méthode de livraison</Label>
                                                         <Input
                                                          name='delivery_mode'
                                                                                 id='deliveryMode'
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='type'>Type de chute</Label>
                      <Input
                        name='type'
                        id='type'
                ...
                <Row>
                  ...
                  <Col md={6}>
                    ...
                    <Col sm='4' className="mt-2">
                                                                                  <FormGroup row>
                                                                                                        <Label sm='4'><strong>MONTANT TOTAL </strong></Label>
                                                                                                        <Col sm='8'>
                                                                                                           <Input className='text-right' value={`${dropRequest.total_amount} ${dropRequest.currency}`} disabled/>
                                                                                                        </Col>
                                                                                                      </FormGroup>
                                                                                   <FormGroup row>
                                                                                                       <Label sm='4'><strong>QUANTITÉ TOTALE </strong></Label>
                                                                                                       <Col sm='8'>
