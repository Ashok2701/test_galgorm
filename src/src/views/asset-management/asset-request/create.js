...
import AssestPic from './images/asset1.jpg'
import SerialPic from './images/serial.png'
    ...
    tempProductsList.map((product, pIndex) => {
     ...
     if (qtyflag) {
      setCount(count + 1)
        ...
        toast.warning(
               <ToastContent header='Error' message='La quantité ne peut être nulle' color='danger' />,
...
const setprodCategory = event => {
  ...
  const onSubmit = () => {
    ...
    if (!isAccepted) {
      toast.warning(
        <ToastContent header='Warning' message='Veuillez accepter les conditions générales' color='warning' />,
        { transition: Slide, hideProgressBar: true, autoClose: 2000 }
      )
    }
        ...
        <Col sm='12'>
          <Card>
            <CardHeader className='border-bottom'>
              <CardTitle tag='h4' style={{color : "#17a2b8"}}><b>CRÉATION D'UNE DEMANDE D'ESSAI</b></CardTitle>
            </CardHeader>
            <CardBody className="pt-1">
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Row>
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='address'>Entrepôt <span className='text-danger'>*</span></Label>
                      <Select
                        id='address'
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='carrier'>Département <span className='text-danger'>*</span></Label>
                      <Select
                        id='carrier'
                        theme={selectThemeColors}
                        name='carrier'
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='deliverymode'>Placement <span className='text-danger'>*</span></Label>
                      <Select
                        id='deliverymode'
                        theme={selectThemeColors}
                        name='delivery_mode'
                ...
                <div className='d-flex justify-content-between align-items-center'>
                  <h4 className='mb-0'>Actif - Détails</h4>
                        ...
                        <fieldset name={fieldName} key={fieldName}>
                          <Tag key={i}>
                            <Row className='justify-content-between align-items-center'>
                               <Col md='2' sm='12'>
                                                                <FormGroup>
                                                                    <Label for={`animation-product-categ-${i}`}>Catégorie d'actifs</Label>
                                                                   <Controller
                                                                                                      ...
                                                                                                      render={({value, name, ref}) => (
                                                                                                        <Select
                                                                                                          ...
                                                                                                          placeholder="Sélectionner la catégorie d'actifs"
                              ...
                              <Col md={2}>
                                <FormGroup>
                                  <Label for={`animation-product-code-${i}`}>ID de l'actif </Label>
                                  <Controller
                              ...
                              <Col md={2}>
 <FormGroup>
                                  <Label for={`animation-product-code-${i}`}>Numéro de série</Label>
                                  <Controller
                                    id={`animation-product-code-${i}`}
                                    control={control}
                                    defaultValue={dropRequest.products[i] ? dropRequest.products[i].product_code : ''}
                                    ...
                                    render={({value, name, ref}) => (
                                      <Select
                                        ...
                                        onChange={updateProduct(i)}
                                        value={productOptions.find(c => c.value === value)}
                                        placeholder='Choisir le numéro de série'
                                        className={classnames('react-select', { 'is-invalid': errors['products'] && errors['products'][i].product_code })}
                                        classNamePrefix='select'
                                        theme={selectThemeColors}
                                      />
                              ...
                              <Col md={1}>
                               ...
                               <Col md={6}>
                                <Label for={`animation-product-code-${i}`}>Photo en série</Label>
                                <Card
                                  style={{
                                    width: '18rem'
                                  }}
                                ...
                                <Col md={6}>
                                 <Label for={`animation-product-code-${i}`}>Photo de l'actif</Label>
                                 <Card
                                                                   style={{
                                                                     width: '18rem'
                                                                   }}
                  ...
                  <Col md={12}>
                    ...
                    <FormGroup>
                      <CustomInput inline 
                        ...
                        label="J'accepte les conditions générales ci-dessus"
