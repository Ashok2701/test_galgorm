...
const setprodCategory = event => {
  ...
  return (
        ...
        <Col sm='12'>
          <Card>
            <CardHeader className='border-bottom'>
              <CardTitle tag='h4' style={{color : "#17a2b8"}}><b> DÉTAILS DE L'ASSEST</b></CardTitle>
            </CardHeader>
            <CardBody className="pt-1">
              <Form onSubmit={handleSubmit(onSubmit)}>
                <Row>
                  <Col md='6' sm='12'>
                    <FormGroup>
                      <Label for='site'>ID de l'actif</Label>
                      <Input
                        name='site'
                        id='site'
                        value="AST10225"
                  ...
                  <Col md='6' sm='12'>
                                      <FormGroup>
                                        <Label for='site'>Nom de l'actif</Label>
                                        <Input
                                          name='site'
                                          id='site'
                                          value="Eye Care"
                 ...
                 <Col md='6' sm='12'>
                                                       <FormGroup>
                                                         <Label for='site'>Catégorie</Label>
                                                         <Input
                                                           name='site'
                                                           id='site'
                                                           value="First Aid Products"
                                                           readOnly
                                                           innerRef={register}
                                                         />
                                                       </FormGroup>
                 ...
                 <Col md='6' sm='12'>
                                                                       <FormGroup>
                                                                         <Label for='site'>Numéro de série</Label>
                                                                         <Input
                                                                           name='site'
                                                                           id='site'
                                                                           value="EC025480"
                  ...
                  <Col md='6' sm='12'>
                    <FormGroup>
                      <Label for='date'>Date d'installation <span className='text-danger'>*</span></Label>
                      <Controller
                        id='date'
                        control={control}
                        name='date'
   ...
   <Col md='6' sm='12'>
                    <FormGroup>
                      <Label for='date'>Date du prochain service<span className='text-danger'>*</span></Label>
                      <Controller
                        id='date'
                        control={control}
                        name='date'
