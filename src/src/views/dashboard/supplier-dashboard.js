    ...
    <div id='dashboard-analytics' className="w-100">
      ...
      <Row>
        <Col md="3">
          <Card>
            <CardHeader>
              <CardTitle tag='h4'>DEMANDES</CardTitle>
        ...
        <Col md="3">
          <Card>
            <CardHeader>
              <CardTitle tag='h4'>ACHAT (USD)</CardTitle>
              <CardText className='card-text font-small-2 mr-25 mb-0'>
                <Moment format="MMMM YYYY"></Moment>
              </CardText>
            </CardHeader>
        ...
        <Col md="3">
          <Card>
            <CardHeader>
              <CardTitle tag='h4'>RECETTES</CardTitle>
              <CardText className='card-text font-small-2 mr-25 mb-0'>
                <Moment format="MMMM YYYY"></Moment>
              </CardText>
            </CardHeader>
              ...
              <div className='expandable-content'>
                <Table bordered responsive className="child-table w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Dernière facture d'achat</td>
