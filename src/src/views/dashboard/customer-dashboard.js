      ...
      <Row>
        <Col md="2">
          <Card style={{backgroundColor : "#6836E9", color : "#fff" }}>
            <CardHeader>
              <CardTitle tag='h4' style={{color : "#fff"}}>CITATIONS</CardTitle>
        ...
        <Col md="2">
          <Card style={{backgroundColor : "#369EE9", color : "#fff" }}>
            <CardHeader>
              <CardTitle tag='h4' style={{color : "#fff"}}>COMMANDES</CardTitle>
              <CardText className='card-text font-small-2 mr-25 mb-0'>
                <Moment format="MMMM YYYY"></Moment>
              </CardText>
            </CardHeader>
        ...
        <Col md="2">
          <Card style={{backgroundColor : "#E9D136", color : "#fff" }}>
            <CardHeader>
              <CardTitle tag='h4' style={{color : "#fff"}}>VENTES ({dashboardData.siteCur})</CardTitle>
              <CardText className='card-text font-small-2 mr-25 mb-0'>
                <Moment format="MMMM YYYY"></Moment>
              </CardText>
            </CardHeader>
            <CardBody>
              <div className="d-flex align-items-center justify-content-between">
                <h1 className="font-weight-bold" style={{color : "#fff"}}><span>{dashboardData.siteCur === 'USD' ? '$' : '£' }  </span>{dashboardData.salesCur}</h1>
                { renderElement(dashboardData.salesCur, dashboardData.salesPrv) }
              </div>
              <p className="card-text line-ellipsis"><Moment subtract={{ months: 1 }} format="MMMM YYYY"></Moment> : <span className="font-weight-bold h4" style={{color : "#fff"}}><span>{dashboardData.siteCur === 'USD' ? '$' : '£' }</span>{dashboardData.salesPrv}</span></p>
            </CardBody>
          </Card>
        </Col>
        <Col md="2">
          <Card style={{backgroundColor : "#51E936", color : "#fff" }}>
            <CardHeader>
              <CardTitle tag='h4' style={{color : "#fff"}}>LIVRAISONS</CardTitle>
              <CardText className='card-text font-small-2 mr-25 mb-0'>
                <Moment format="MMMM YYYY"></Moment>
              </CardText>
            </CardHeader>
        ...
        <Col md="2">
                  <Card style={{backgroundColor : "#A6C0D5", color : "#fff" }}>
                    <CardHeader>
                      <CardTitle tag='h4' style={{color : "#fff"}}>PAIEMENTS</CardTitle>
                      <CardText className='card-text font-small-2 mr-25 mb-0'>
                        <Moment format="MMMM YYYY"></Moment>
                      </CardText>
                    </CardHeader>
                    <CardBody>
                      <div className="d-flex align-items-center justify-content-between">
                        <h1 className="font-weight-bold" style={{color : "#fff"}}><span>{dashboardData.siteCur === 'USD' ? '$' : '£' }  </span>{dashboardData.paymentCur}</h1>
                        { renderElement(dashboardData.paymentCur, dashboardData.paymentPrv) }
                      </div>
                      <p className="card-text line-ellipsis"><Moment subtract={{ months: 1 }} format="MMMM YYYY"></Moment> : <span className="font-weight-bold h4" style={{color : "#fff"}}><span>{dashboardData.siteCur === 'USD' ? '$' : '£' }  </span>{dashboardData.paymentPrv}</span></p>
                    </CardBody>
                  </Card>
                </Col>
         <Col md="2">
                           <Card style={{backgroundColor : "#0F5F8A", color : "#fff" }}>
                             <CardHeader>
                               <CardTitle tag='h4' style={{color : "#fff"}}>PAIEMENT TOTAL DÛ</CardTitle>
                               <CardText className='card-text font-small-2 mr-25 mb-0'>
                             ...
                             <CardBody>
                               <div className="d-flex align-items-center justify-content-between">
                                 <h1 className="font-weight-bold" style={{color : "#fff"}}><span>{dashboardData.siteCur === 'USD' ? '$' : '£' }  </span>{dashboardData.paymentDue}</h1>
        ...
        <Col md='12'>
          <Card>
            <CardHeader className='border-bottom' style={{backgroundColor : "moccasin" }}>
              <CardTitle tag='h4' >Ventes par période et par produit</CardTitle>
            </CardHeader>
        ...
        <Col md='12'>
          <Card>
            <CardHeader className='border-bottom' style={{backgroundColor : "cadetblue" }}>
              <CardTitle tag='h4'>Dernières opérations</CardTitle>
            </CardHeader>
            <CardBody className='mt-2'>
              <div className='expandable-content'>
                <Table bordered responsive className="child-table w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Dernière commande client</td>
                    ...
                    <tr>
                      <td>Dernière livraison de vente</td>
                    ...
                    <tr>
                      <td>Dernière facture de vente</td>
        ...
        <Col md='12' lg='6'>
          <Card>
            <CardHeader className='border-bottom' style={{backgroundColor : "#FFC300" }}>
              <CardTitle tag='h4'>Forum de discussion</CardTitle>
            </CardHeader>
            <CardBody className='mt-2'>
              <div className='expandable-content'>
                <Table bordered responsive className="child-table w-100">
        ...
        <Col md='12' lg='6'>
          <Card>
            <CardHeader className='border-bottom' style={{backgroundColor : "#369EE9", color : "#fff" }}>
              <CardTitle tag='h4'>Annonces</CardTitle>
            </CardHeader>
            <CardBody className='mt-2'>
              <div className='expandable-content'>
                <Table bordered responsive className="child-table w-100">
