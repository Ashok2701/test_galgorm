...
import { X, Heart, Star, Check, Plus, Minus } from 'react-feather'
...
const qtyChange = (e) => {
   console.log("on Qty change in cart", e)
  ...
  const renderCart = () => {
    return products.map((item, i) => {
      return (
        <Card key={i} className='ecommerce-card'>
          ...
          <CardBody>
            ...
            <div className='item-quantity' style={{width : "205px"}}>
              <span className='quantity-title mr-50'>Qty</span>
                <InputGroup

                                           >
                                            <InputGroupAddon addonType='prepend' onClick={() => { props.handleDecrement(item, i) }}>
                                              <Button
                                                className='btn-icon'
                                                color='transparent'
                                              >
                                            ...
                                            <Input
                                              ...
                                              type='number'
                                              value={item.QTY_0}
                                              onChange={() => { handleInputChange(event, i, item) }}
                                              />
                                            <InputGroupAddon addonType='append' onClick={() => { props.handleIncrement(item, i) }}>
                                              <Button
                                                className='btn-icon'
                                                color='transparent'
                                              >
