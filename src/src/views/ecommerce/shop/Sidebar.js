          ...
          <Card>
            <CardBody>
              <div className='multi-range-price'>
                <h6 className='filter-title mt-0'>Gamme multiple</h6>
              ...
              <div className='price-slider'>
                <h6 className='filter-title'>Fourchette de prix</h6>
                <div className='price-slider'>
                  <Nouislider
              ...
              <div id='product-categories'>
                <h6 className='filter-title'>Catégories</h6>
              ...
              <div className='brands'>
                <h6 className='filter-title'>Marques</h6>
              ...
              <div id='ratings'>
                <h6 className='filter-title'>Notations</h6>
                {ratings.map(item => {
                  return (
