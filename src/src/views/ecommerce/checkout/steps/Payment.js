  ...
  return (
    ...
    >
      <div className='payment-type'>
        <Card>
          <CardHeader className='flex-column align-items-start'>
            ...
            <CardText className='text-muted mt-25'>Assurez-vous de cliquer sur la bonne option de paiement</CardText>
          </CardHeader>
          <CardBody>
            ...
            <div className='gift-card mb-25'>
              <CardText>
                ...
                <span className='align-middle'>Ajouter une carte cadeau</span>
              </CardText>
            </div>
          </CardBody>
        </Card>
      ...
      <div className='amount-payable checkout-options'>
        <Card>
          <CardHeader>
            <CardTitle tag='h4'>Détails du prix</CardTitle>
          </CardHeader>
          <CardBody>
            <ul className='list-unstyled price-details'>
              ...
              <li className='price-detail'>
                <div className='details-title'>Frais de livraison</div>
            ...
            <ul className='list-unstyled price-details'>
              <li className='price-detail'>
                <div className='details-title'>Montant à payer</div>
