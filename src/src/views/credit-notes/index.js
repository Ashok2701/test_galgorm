...
const CreditNoteComponent = () => {
  ...
  const status = {
    1: { title: 'Non publié', color: 'light-warning' },
    2: { title: 'Non utilisé', color: 'light-dark' },
    3: { title: 'Affiché', color: 'light-success' }
  }
  
  const paymentStatus = {
    0: { title: 'NA', color: 'light-danger' },
    1: { title: 'Payer', color: 'light-dark' },
    2: { title: 'Payé', color: 'light-success' },
    3: { title: 'Partiellement payé', color: 'light-warning' }
  }
  ...
  const columns = [
    ...
    {
      name: 'Commentaires sur la facture',
      selector: 'DES_0',
      sortable: true,
      minWidth: '160px'
    },
    {
      name: 'État des paiements',
      selector: 'Status',
      sortable: true,
      minWidth: '100px',
      cell: row => {
        ...
        <Col sm='12'>
          <Card>
            <CardHeader className='flex-md-row flex-column align-md-items-center border-bottom'>
              <CardTitle tag='h4'>Notes de crédit</CardTitle>
              ...
              <Col md='4' lg='3' className='mt-1'>
                <FormGroup>
                  <Select
                    ...
                    placeholder='État des paiements'
