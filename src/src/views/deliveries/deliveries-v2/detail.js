...
const DeliveryDetail = (props) => {
  ...
  const status = {
    0: { title: 'Planifier', color: 'light-dark' },
    1: { title: 'Prévu', color: 'light-info' },
    2: { title: 'En route', color: 'light-primary' },
    3: { title: 'En cours', color: 'light-primary' },
    4: { title: 'Terminé', color: 'light-success' },
    5: { title: 'Sautée', color: 'light-warning' },
    6: { title: 'Reprogrammé', color: 'light-warning' },
    7: { title: 'Annulé', color: 'light-danger' },
    8: { title: 'Planifier', color: 'light-dark' }
  }
            ...
            <Card>
              ...
              <CardBody>
                <Row className='mt-2'>
                  <Col md='4'>
                    <FormGroup row>
                      <Label sm='5'>NUMÉRO DE LIVRAISON</Label>
                      <Col sm='7'>
                    ...
                    <FormGroup row>
                                          <Label sm='5'>ADRESSE DE LIVRAISON</Label>
                                          <Col sm='7'>
                                            <Input value={`${delivery.BPAADD_0} (${delivery.BPDNAM_0})`} disabled/>
                                          </Col>
                                        </FormGroup>
                    <FormGroup row>
                                                             <Label sm='5'>MONNAIE</Label>
                                                             <Col sm='7'>
                  ...
                  <Col md='4'>
                    <FormGroup row>
                      <Label sm='5'>DÉLAI DE LIVRAISON</Label>
                      <Col sm='7'>
                        <Input value={delivery.DAYLTI_0} disabled/>
                      </Col>
                    </FormGroup>
                    <FormGroup row>
                      <Label sm='5'>ÉTAT DES TRANSPORTS</Label>
                      <Col sm='7'>
                        <Input value={status[delivery.XDLV_STATUS_0].title} disabled/>
                      </Col>
                    </FormGroup>
                    <FormGroup row>
                                          <Label sm='5'>TRANSPORTEUR</Label>
                                          <Col sm='7'>
