...
const CreateUserComponent = (props) => {
  ...
  return (
    <div className="w-100">
      ...
      <CardTitle tag='h4' className="mb-0">INFORMATIONS SUR L'UTILISATEUR</CardTitle>
      <Button type='button' color='secondary' outline tag={Link} to='/admin/users'>Retour</Button>
      </div>
      <Row>
        <Col sm='12'>
            ...
            <Card>
              <CardBody className="pt-1">
                <Row>
                  ...
                  <Col md='4' sm='12'>
                    <FormGroup>
                      <Label for='contact'>Code de contact</Label>
                      <Input
                        name='concode'
                        id='concode'
                        value={user.concode}
