...
const handleQtyChange = (e) => {
   console.log("insdie qty change event at cart", e)
}
        ...
        <Card key={item.ITMDES_0} className='ecommerce-card'>
          ...
          <CardBody>
            ...
            <div className='item-quantity'>
              ...
              <NumberInput value={item.QTY_0} min={1}  onIncrement={() => props.handleIncrement(item, i)} onDecrement ={() => props.handleDecrement(item, i)}  size='sm' style={{ width: '7rem', height: '2.15rem' }} />
            </div>
            </CardBody>
