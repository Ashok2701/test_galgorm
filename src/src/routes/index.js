...
import LVS from "../pages/LVS/index";

import TrackInventory from "../pages/TrackInventory/index";
...
//Scheduler
import Scheduler000 from "../pages/Scheduler000/index";
import Scheduler2 from "../pages/Scheduler2/index";
import schedulerDriver from "../pages/Scheduler-Driver/index";

//SchedulerDocs
import SchedulerDocs from "../pages/SchedulerDocs/index";
...
//delviery Automations
   {path : "/operation/lvs", component: LVS},


//Track Vehicle Inventory
  {path : "/trackInventory", component : TrackInventory},
...
{ path: "/user", component: Users },
  ...
  //Scheduler
  {path: "/scheduler000", component : Scheduler000},
   {path: "/scheduler2" , component : Scheduler2},
   {path: "/scheduler-Driver", component : schedulerDriver},

   //Appointments
     {path: "/appointment" , component : Appointments},

  //SchedulerDocs
  {path: "/schedulerdocs" , component : SchedulerDocs},



  // this route should be at the end of all other routes
  { path: "/", exact: true, component: () => <Redirect to="/Scheduler2" /> },
];
