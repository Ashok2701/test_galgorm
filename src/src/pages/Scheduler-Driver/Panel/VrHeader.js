...
class VrHeader extends React.Component {
  ...
  render(){
     var trip = this.props.tripdetails;
          ...
          const vr_url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CPLC/2//M/" + this.props.vrdata.xnumpc;
                       ...
                       <CardBody>
                         ...
                         <Row className="my-3">
                           ...
                           <Col lg="3" xl="2">
                                ...
                                <p className="mb-0 h6 text-primary">{trip.lock ? this.getlvsstatus(this.props.loadvehstck.xloadflg) : ''}</p>
                                <hr className="mt-1" />
                           </Col>
                           ...
                           <Col lg="3" xl="2">
                             ...
                             <p className="mb-0 h6 text-primary">{trip.lock ? this.props.vrdata.trailer : trip && trip.trialerObject && trip.trialerObject.trailer && trip.trialerObject.trailer}</p>
                             <hr className="mt-1" />
                           </Col>
                           <Col lg="3" xl="2">
                           ...
                           <Col lg="3" xl="2">
                             ...
                             <p className="mb-0 h6 text-primary">{trip.lock ? vrtype : ''}</p>
                             <hr className="mt-1" />
                           </Col>
                           <Col lg="3" xl="2">
                           ...
                           <Col lg="3" xl="2">
                             ...
                             <p className="mb-0 h6 text-primary">{trip.lock ? execTime : trip.heuexec}</p>
                             <hr className="mt-1" />
                           </Col>
                           <Col lg="3" xl="2">
