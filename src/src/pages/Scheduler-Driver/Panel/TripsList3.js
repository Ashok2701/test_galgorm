...
class TripsList3 extends React.Component {
                            ...
                            if (data && legs && data.stops < results[0].legs.length) {
                              ...
                              //  setHandleDateChange = departure;
                                ...
                                if (prevTripsDist >= data.vehicleObject.maxtotaldist
                                    ...
                                    || tripsClosed) {
                                    if (prevTripsDist >= data.vehicleObject.maxtotaldist) {
                                        setDistErrorMessage(`The vehicle cannot perform trip more than ${data.vehicleObject.maxtotaldist} KM, please review trip documents.`)
                                        setDistError(true);
 ...
 console.log("TTTT lvs status =",lvsStatus);
   ...
   console.log("TTTT lvs status =",lvsStatus);
               ...
               return <span class='badge badge-dark text-uppercase' style={{ fontSize: 14  }}>{this.props.t('DISPATCHED')}</span>;
         }
