    ...
    <Paper className={classes.root} elevation={0}>
      {props.dataList &&
        ...
        props.dataList.map((data, index) => {
          ...
          const vr_url =
            "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CPLC/2//M/" +
            data.itemCode;
          const loadvehstock_url =
            "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CS/2//M/" +
            data.lvsno;
