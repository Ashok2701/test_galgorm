        ...
        return (
            ...
            <TabPane tabId="Trips">
              <Card className="mb-3">
                                      ...
                                      <div className="reportlist-view1 tablheight1">
                                          <table className="table m-0">
                                              <thead>
                                                  <tr className="">
                                                      ...
                                                      <th width="10%"> {this.props.t('RouteCode')}</th>
                                                      ...
                                                      <th width="2%"> {this.props.t('ENLV')}</th>
                                                      <th width="2%"> {this.props.t('LIV')}</th>
                                                      <th width="2%"> {this.props.t('Stops')}</th>
                                                      <th > Log </th>
                                                  </tr>
                                              </thead>
                                              <tbody>
                                                  {(this.props.tripsList && this.props.tripsList || []).map((trip, i) => (
                                                      ...
                                                      <tr className="bg-blue" style={{ backgroundColor: this.getBgcolor(trip.code) }} key={i}>
                                                          ...
                                                          <td width="10%"><span className="vid">{trip.itemCode}</span></td>
                                                          <td ><span className="vtrips">{trip.trips}</span></td>
                                                          <td width="6%"><b>{trip.code}</b></td>
                                                          <td width="5%"><span style={{ fontSize: '12pt'}} >{trip.optistatus ? trip.optistatus == "Optimized" ? this.props.t('Optimized') : nullAndNanChecking(trip.optistatus, 'status') : 'Open'}</span></td>
                                                                                                      <td width="3%">
                                                                                                          {
