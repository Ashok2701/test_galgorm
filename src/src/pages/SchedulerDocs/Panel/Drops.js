...
class Drops extends React.Component {
   ...
   getBgcolor(type, docnum, doctype) {
    ...
    displayDropStatus = (vStatus, x) => {
     ...
     displayDocImage = (type) => {

       if(type === 'DLV' || type === 'PICK') {
          return (
               <img src="assets/img/drops.png" alt="drops" class="rounded-circle" width="50"></img>
          )
       }
       else {
         return (
            <img src="assets/img/pickup.png" alt="drops" class="rounded-circle" width="50"></img>
         )
       }
     }
    ...
    render() {
        ...
        return (
           ...
           <Row className="my-2">
            ...
            <div class="reportlist-view1 tableCustomFixHead">
                {/* <table class="table table-striped m-0">  */}
                <table class= {"table table-sm "+ (this.props.dayschecked ? " " : "table-striped m-0")}>
                        ...
                        {(dropList || []).map((drops, i) => {
                            ...
                            return (
                                <tr id={'drops' + i}
                                    ...
                                    key={'drops' + i}
                                >
                                    <td>{this.displayDocImage(drops.doctype)}</td>
                                    <td>
                                    ...
                                    <td >{this.displayTypeDocBadge(drops.doctype, drops.pairedDoc)}</td>
                                     <td>
                                                                                                                {/* <span className= { this.colorStyle(drops.type) }>{drops.type}</span> */}
                                                                                                                <td >{this.displayDropStatus(drops.type,drops.dlvystatus)}</td>
                                                                                                             </td>
                                    <td>{drops.bpcode}</td>
                                    <td>{drops.bpname}</td>
