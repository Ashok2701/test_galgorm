    ...
    getDocink = (tripData) => {
       ...
       var url = "";
                   ...
                   if (tripData.doctype == 'PRECEIPT') {
                       url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CPTH/2//M/" + tripData.docnum;
                      return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                       ...
                       url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESSDH/2//M/" + tripData.docnum;
                      return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                      );
                   }
                   else if (tripData.doctype == 'PICK') {
                       url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESPRH2/2//M/" + tripData.docnum;
                     return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                     );
                   }
                   else if (tripData.doctype == 'MISCPICK') {
                                          url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CMIS/2//M/" + tripData.docnum;
                                        return (<a name="Subject" className="e-field e-input" target="_blank" href={url}><span style={{color : 'black', fontSize : '14px'}}>{tripData.docnum}</span></a>
                                        );
                                      }
                   else {
                       url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESFCY/2//M/" + tripData.docnum;
                       return '';
                   }
