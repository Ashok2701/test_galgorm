  ...
  render() {
    ...
    this.props.vehicles &&
      ...
      this.props.vehicles.map((vehicle) => {
        if (vehicle.codeyve == this.props.selectedVehicleCode) {
          selectedVehicleCode = vehicle;
          placeHolder = vehicle.name;
          optionSelected.value = vehicle.techId;
          optionSelected.label = vehicle.techId + "," + vehicle.name;
        }
        optionVehicleCodeItems.push({
          value: vehicle.name,
          label: vehicle.techId + "," + vehicle.name,
        });
      });
      ...
      <>
        <Form className="row_nav">
          ...
          >
            ...
            <button type="button" class="btn btn-info" onClick={this.depalnify}>
