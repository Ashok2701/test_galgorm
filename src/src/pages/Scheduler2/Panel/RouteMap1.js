...
class RouteMap extends React.Component {
  ...
  buildContent = (place) => {
    ...
    const url =
      "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESSDH/2//M/" +
      place.docnum;
    return (
      <div id="content">
    ...
    if (this.props.markers !== undefined && this.props.markers.length > 0) {
      ...
      markerArray.map((place) => {
        ...
        if (place.doctype == "PRECEIPT") {
          url =
            "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CPTH/2//M/" +
            place.docnum;
          if (place.tripno == 0)
            content =
          ...
          url =
            "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESPRH2/2//M/" +
            place.docnum;
          if (place.tripno == 0)
            content =
              "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" +
          ...
          url =
            "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESFCY/2//M/" +
            place.docnum;
          content =
            "<div id='content'><div id='siteNotice'></div><div id = 'bodyContent'><a href=" +
            url +
  ...
  onDocClick = (product, docNum, doctype, skillreq) => {
  ...
  render() {
    ...
    return (
      <div class="routeMapOuter" style={{height:"100%"}}>
                  ...
                  (geoData, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td width="6%">{ data.serTime && data.serTime.length > 0 ? formatTime(data.serviceTime) : splitTime(data.serviceTime)}</td>
