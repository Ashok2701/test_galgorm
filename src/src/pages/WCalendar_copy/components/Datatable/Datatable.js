        ...
        <Table className={classes.table} aria-label="simple table">
          ...
          <TableBody>
            {props.tripList && props.tripList.map((row, index) => {
              var arr = row.times;
     const vr_url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CPLC/2//M/" + row.itemCode;
        const loadvehstock_url = "https://tms.tema-systems.com/syracuse-main/html/main.html?url=/trans/x3/erp/DEMOTMSFR/$sessions?f=GESXX10CS/2//M/" + row.lvsno;
